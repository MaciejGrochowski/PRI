...
public class PersonalityGenerator extends GeneralService {
    ...
    public Map<String, String> generatePersonalities(Character character, HashMap<String, String> properties) {
        ...
        int personalityCount = randomPersonalityCount(rand.nextDouble());
