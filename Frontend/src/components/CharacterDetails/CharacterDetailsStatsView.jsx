...
<div className="column-1">
                <div className="flex-component"><div className = "stats-name">Imię</div><div className = "yellow-color" >{data.name}</div></div>
                <div className="flex-component"><div className = "stats-name">Nazwisko</div> <div className = "yellow-color">{data.surname}</div></div>
                <div className="flex-component"><div className = "stats-name">Rasa</div> <div className = "yellow-color">{data.race}</div></div>
                <div className="flex-component"><div className = "stats-name">Płeć</div> <div className = "yellow-color">{data.sex}</div></div>
...
<div className = "block-element"><div className="flex-component"><div className = "stats-name">Wzrost/Waga</div> <div className = "yellow-color">{data.height} cm / {data.weight} kg</div></div></div>
                ...
                <div className="flex-component"><div className = "stats-name">Dominujące emocje</div> <div className = "yellow-color">{data.dominatingEmotions}</div></div>
