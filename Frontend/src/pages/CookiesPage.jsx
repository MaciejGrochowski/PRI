    ...
    render(){
        return (
            <div className = "plainPage">
                <h1>Cookie Policy for Ja Nie Taki Ork</h1>

                <p>This is the Cookie Policy for Ja Nie Taki Ork, accessible from https://janietakiork.projektstudencki.pl</p>
                ...
                <ul>
                    <li>Email: janietakiork@gmail.com</li>
